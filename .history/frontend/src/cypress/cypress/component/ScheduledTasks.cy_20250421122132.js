...
// We'll need to mock TaskCard component
// The actual implementation will depend on how your TaskCard component is structured
...
describe('ScheduledTasks Component', () => {
  beforeEach(() => {
    ...
    cy.window().then((win) => {
      ...
      cy.stub(win, 'TaskCard').callsFake(mockTaskCard);
  ...
  it('handles tasks with MongoDB-style _id', () => {
    ...
    cy.contains('MongoDB-style Task').should('be.visible');
  });
