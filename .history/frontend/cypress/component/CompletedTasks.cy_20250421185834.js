...
describe('CompletedTasks Component', () => {
  ...
  it('renders task details correctly', () => {
    ...
    cy.get('.completed-task-card').first().within(() => {
      ...
      cy.contains('This is a completed task').should('be.visible');
      cy.contains('04/20/2025').should('be.visible');  // Assuming TaskCard displays formatted date
      cy.contains('$25').should('be.visible');  // Assuming TaskCard displays the pay rate
    });
  });
});